...
public class BaktygulFindMaxAndMinInArray {
    public static void main(String[] args) {
        //From an array of numbers find the smallest and the biggest integers and extract them to a new array.Note:
        // Numbers must be in random order.  Numbers in Array also can or should contain negatives such as -1 or 0.
