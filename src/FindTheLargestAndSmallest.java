...
public class FindTheLargestAndSmallest {
    public static void main(String[] args){
        ...
        numbers[0]=user.nextInt();
        System.out.println("Enter second Array element");
        numbers[1]=user.nextInt();
        System.out.println("Enter third Array element");
        numbers[2]=user.nextInt();
        System.out.println("Enter fourth Array element");
        numbers[3]=user.nextInt();
